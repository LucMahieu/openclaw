  ...
  try {
    ...
    try {
      ...
      const subscription = subscribeEmbeddedPiSession({
        ...
        toolSummaryStyle: params.toolSummaryStyle,
        toolSummaryMaxWords: params.toolSummaryMaxWords,
        toolSummaryDedupWindowMs: params.toolSummaryDedupWindowMs,
        toolSummarySuppressRepeats: params.toolSummarySuppressRepeats,
        toolSummaryRedactInternals: params.toolSummaryRedactInternals,
