...
const palette = {
  ...
  toolErrorBg: "#2F1F1F",
  toolBarBulletRunning: "#60a5fa",
  toolBarBulletDone: "#34d399",
  toolBarBulletError: "#F97066",
  toolBarBulletDefault: "#94a3b8",
  toolTitle: "#F6C453",
  toolOutput: "#E1DACB",
  quote: "#8CC8FF",
  quoteBorder: "#3B4D6B",
...
export const theme = {
  ...
  toolBarBulletRunning: fg(palette.toolBarBulletRunning),
  toolBarBulletDone: fg(palette.toolBarBulletDone),
  toolBarBulletError: fg(palette.toolBarBulletError),
  toolBarBulletDefault: fg(palette.toolBarBulletDefault),
