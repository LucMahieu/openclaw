...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.selfImprovement": "Self Improvement",
  "agents.defaults.selfImprovement.handoff.monitorEnabled": "Handoff Monitor Enabled",
  "agents.defaults.selfImprovement.handoff.monitorIntervalSeconds": "Handoff Monitor Interval (s)",
  "agents.defaults.selfImprovement.handoff.monitorMaxAttempts": "Handoff Max Attempts",
  "agents.defaults.selfImprovement.handoff.staleTimeoutSeconds": "Handoff Stale Timeout (s)",
  "agents.defaults.selfImprovement.handoff.requirePushAck": "Handoff Require Push Ack",
  "agents.defaults.selfImprovement.handoff.autoRescheduleOnInFlight": "Handoff Auto Reschedule",
  "agents.defaults.selfImprovement.handoff.retryBackoffSeconds": "Handoff Retry Backoff (s)",
  ...
  "channels.whatsapp.toolSummaryStyle": "WhatsApp Tool Summary Style",
  "channels.whatsapp.toolSummaryMaxWords": "WhatsApp Tool Summary Max Words",
  "channels.whatsapp.toolSummaryDedupWindowMs": "WhatsApp Tool Summary Dedupe Window (ms)",
  "channels.whatsapp.toolSummarySuppressRepeats": "WhatsApp Tool Summary Suppress Repeats",
  "channels.whatsapp.toolSummaryRedactInternals": "WhatsApp Tool Summary Redact Internals",
